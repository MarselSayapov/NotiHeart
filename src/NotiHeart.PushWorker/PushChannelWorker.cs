...
public sealed class PushChannelWorker : BackgroundService, IDisposable
{
    ...
    public PushChannelWorker(
        ...
        ILogger<PushChannelWorker> logger)
    {
        ...
        _routingKey = NotificationRouting.GetRoutingKey(NotificationChannel.Push);
        _queueName = NotificationRouting.GetQueueName(NotificationChannel.Push);
        _retryQueueName = NotificationRouting.GetRetryQueueName(NotificationChannel.Push);
        _deadLetterQueueName = NotificationRouting.GetDeadLetterQueueName(NotificationChannel.Push);
        _deadLetterExchange = NotificationRouting.GetDeadLetterExchange(NotificationChannel.Push);
